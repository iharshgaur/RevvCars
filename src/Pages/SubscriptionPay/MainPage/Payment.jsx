      ...
      <div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.tentureBox}>
            ...
            <div
              onClick={() => hanldeActive("12")}
              className={boxActive === "12" ? styles.bg : null}
            >
              <p className={styles.tentureBox_p1}>12</p>
              <p className={styles.tentureBox_p2}>Months</p>
            </div>
            <div
              onClick={() => hanldeActive("24")}
              className={boxActive === "24" ? styles.bg : null}
            >
              <p className={styles.tentureBox_p1}>24</p>
              <p className={styles.tentureBox_p2}>Months</p>
            </div>
            <div
              onClick={() => hanldeActive("36")}
              className={boxActive === "36" ? styles.bg : null}
            >
          ...
          <p className={styles.price}>
            ₹ {discountPrice}
            <span className={styles.price_span1}>/month</span>
            <span className={styles.price_span2}>₹ {originalPrice}</span>
            <span className={styles.price_span3}>
              ({data?.car_discount}% off)
            </span>
          </p>
          <img
            className={styles.offerImg}
            src="https://www.revv.co.in/grapheneImages/summary-page/percentage.svg"
            alt="pic"
          />
          <label className={styles.offerImgP}>View the offer</label>
          <div className={styles.payContainer}>
            <p
              className={styles.payContainerP}
              onClick={() => handleRoute(data?._id, price)}
            >
              Proceed &#8883;
            </p>
          </div>
          <p className={styles.deliveryP}>
            ...
            <span className={styles.deliveryspan}>Place of delivery</span>
          </p>
          <img
            className={styles.deliverySpark}
            src="https://www.revv.co.in/grapheneImages/PDP/flash.svg"
            alt="pic"
          />
          <label className={styles.deliveryl1}>Within Days</label>
          <label className={styles.deliveryl2}>At your doorstep</label>
          <p className={styles.deliverygold}>
            Due to high demand, delivery timelines may be impacted
          </p>
          <img
            className={styles.deliverySpark}
            src="https://www.revv.co.in/grapheneImages/PDP/green-tick-icon.svg"
            alt="pic"
          />
          <label className={styles.detailsl1}>
